...
/// let word_count = wc_rust::count_words(content);
/// 
...
/// ```
/// let content = "hello, world";
/// let byte_count = wc_rust::count_bytes(content);
/// 
...
/// ```
/// let content = "hello\nworld\n";
/// let line_count = wc_rust::count_lines(content);
/// 
...
/// ```
/// let content = "hello, world";
/// let char_count = wc_rust::count_chars(content);
/// 
